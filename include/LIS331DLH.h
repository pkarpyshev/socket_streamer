...
const uint8_t ctrl_reg4_value = block_data_update | big_endian_selection |
    full_sclae_selection | self_test_sign | self_test_enable |
    spi_mode_selection;

#define STATUS_REG 0x27
uint8_t zyx_available(uint8_t status_reg){
